...
const SingleBook = () => {
  ...
  useEffect(() => {
    const fetchBook = async () => {
      try {
        ...
        const response = await axios.get(`https://backend-alpha-dusky-96.vercel.app/api/get-book/${id}`, {
          headers: {
        ...
        const relatedResponse = await axios.get(`https://backend-alpha-dusky-96.vercel.app/api/related-books`, {
  ...
  const handleDelete = async () => {
    try {
      const id = 1
      await axios.delete(`https://backend-alpha-dusky-96.vercel.app/api/delete-book/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`
        },
      });
